/**
 * @file template/animation/05-mot-stagger/template.js
 * @description Stagger Plafonné MOT (Multiple Object Tracking) (Cavanagh & Alvarez (2005)) — kit-charts
 */
(function(global, factory) {
  if (typeof exports === 'object' && typeof module !== 'undefined') {
    ...
    global.KitCharts["anim-05-mot-stagger"] = exp;
    global.KitCharts["anim-mot-stagger"] = exp;
    global.createChart = exp.createChart;
    global.DEFAULT_DATA = exp.DEFAULT_DATA;
    global.ALT_DATA = exp.ALT_DATA;
    global.playTransition = exp.playTransition;
    global.triggerMotStagger = exp.triggerMotStagger;
  }
  ...
  const ALT_DATA = {
    ...
    datasets: [
      {
        label: "Score Actualisé en Cascade",
        data: [92, 85, 80, 95, 74, 90, 86, 92]
      }
    ]
  };
  ...
  function createChart(canvas, customData = null, themeName = "colorbrewer-accessible", options = {}) {
    ...
    const dur = options.reducedMotion ? 0 : (options.duration !== undefined ? options.duration : 700);
  ...
  function playTransition(chart, targetData = null, options = {}) {
    ...
    if (chart.options && chart.options.animation) {
      ...
      chart.options.animation.delay = (ctx) => {
        if (dur === 0) return 0;
        return getStaggerDelay(ctx, { unitMs: 300, overlapCap: 4, duration: dur });
      };
    }
  ...
  return {
    ...
    triggerMotStagger: playTransition,
